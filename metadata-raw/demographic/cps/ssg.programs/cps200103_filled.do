...
clear all
log using "cpsmar.cps200103_modified.log",text replace
use "$CPSNBER/cpsmar_person_2001.dta", replace
...
append using "$ZEROOBS/cps200103pp.dta"

*Step 6: Save file
save "$Output/cps200103pp_filled.dta"
