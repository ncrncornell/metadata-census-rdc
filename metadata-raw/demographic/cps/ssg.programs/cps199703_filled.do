...
clear all
log using "$Programs/cpsmar.cps199703_modified.log",text replace
use "$CPSNBER/cpsmar_person_1997.dta", replace
...
*/ pemntvty pefntvty dephi care othstper curr curtyp_1 curtyp_2 curtyp_3 curtyp_4 curtyp_5 /*       
...
*/peabsrsn peio1cow prnlfsch pehruslt penatvty peinusyr prcitshp pxnatvty pxmntvty pxfntvty{
...
*/ lkweeks lkstrch pyrsn phmemprs hrswk hrcheck ptyn ptweeks ptrsn ljcw /*
*/ wexp wewkrs welknw weuemp earner clwk weclw poccu2 wemocg weind wemind /*
*/ migsame  noemp ern_yn ern_srce ern_otr curtyp_1 curtyp_2 curtyp_3 curtyp_4 curtyp_5 /* 
*/ wageotr wsal_yn seotr semp_yn frmotr frse_yn uc_yn subuc strkuc wc_yn /*
...
*/ ptot_r perlis mcare mcaid champ wrk_ck penplan penincl cov_gh cov_hi /*
*/ ch_mc ch_hi axrrp axparent axage axmaritl axspouse axsex axvet /*
*/ axhga  axrace axorigin axlfsr axhrs curr /*
...
append using "$ZEROOBS/cps199703pp.dta"
*** Save file ***
save "$Output/cps199703pp_filled.dta", replace
