...
capture log close
include config.do
///Open log file and use data 1991///

clear all
log using "$Programs/cpsmar_cps199103_modified.log",text replace
use "$CPSNBER/cpsmar_person_1991.dta"

///Drop variables not contained in zero-obs dataset///
drop i_* hrecord h_seq hhpos huunits h_faminc h_respnm scmst h_hhtype h_numper /*
*/ hnumfam h_type h_month h_year h_mis h_hhnum h_livqrt h_typebc h_tenure h_telhhd /*
*/h_telavl h_telint hg_* hmssz hpmsasz hmsa_r hccc_r hfarm hunder15 /*
...
*/grn_plac placdscp apchkwj apnlfrot apearnrt tc* a_werntf a_herntf /*
...
foreach v of var precord pppos a_lineno a_parent a_exprrp a_age a_maritl /* 
*/a_spouse a_sex a_vet a_hga a_hgc a_race p_stat a_reorgn a_famnum /* 
*/a_famtyp a_famrel a_pfrel hhdrel famrel hhdfmx parent age1 /*  
*/schl1 phf_seq pf_seq prnt_ptr a_majact a_anywk a_hrs1 a_hrschk a_uslft /* 
*/a_ftreas a_lostim a_ovrtim a_jobabs a_whyabs a_payabs a_ftabs a_lkwk /* 
*/a_mthd1 a_mthd2 a_mthd3 a_mthd4 a_mthd5 a_mthd6 a_mthd7 a_whylk a_wkslk a_lkftpt a_avail a_whyna a_whenlj a_clswkr /* 
*/a_nlflj a_whylft a_wantjb a_whynl1 a_whynl2 a_whynl3 a_whynl4 a_whynl5 a_whynl6 /*  
*/a_whynl7 a_whynl8 a_whynl9 a_whynla a_whynlb a_intend a_uslhrs a_hrlywk a_unmem /* 
...
*/migsame grin_reg grin_st mig_mtr1 mig_mtr3 mig_mtr4 migsun noemp ern_yn ern_srce ern_otr /*  
...
*/ret_sc1 ret_sc2 int_yn div_yn div_non rnt_yn ed_yn oed_typ1 oed_typ2 oed_typ3 csp_yn alm_yn fin_yn oi_off oi_yn /*  
...
*/axhga axhgc axrace axorigin axlfsr axmajact axanywk axhrs axhrschk /* 
...
foreach v in precord pppos a_lineno a_parent a_exprrp a_age a_maritl /* 
*/a_spouse a_sex a_vet a_hga a_hgc a_race p_stat a_reorgn a_famnum /* 
*/a_famtyp a_famrel a_pfrel hhdrel famrel hhdfmx parent age1 /*  
*/schl1 phf_seq pf_seq prnt_ptr a_majact a_anywk a_hrs1 a_hrschk a_uslft /* 
*/a_ftreas a_lostim a_ovrtim a_jobabs a_whyabs a_payabs a_ftabs a_lkwk /* 
...
///Save the variable labels in a local macro///
foreach v of var a_ind a_occ industry occup {
 	local l`v' : variable label `v'
        if `"`l`v''"' == "" {
 		local l`v' "`v'"
  	}
...
append using "$ZEROOBS/cps199103pp.dta"
///Save file///
save "$Output/cps199103pp_filled.dta", replace
