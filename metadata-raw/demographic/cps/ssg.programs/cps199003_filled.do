...
clear all
log using "$Programs/cpsmar_cps199003_modified.log",text replace
use "$CPSNBER/cpsmar_person_1990.dta"
...
*/a_vet a_hgc a_race p_stat a_reorgn a_famnum a_famtyp a_famrel a_pfrel hhdrel /*
*/ famrel hhdfmx parent age1 schl1 phf_seq pf_seq prnt_ptr a_majact /*
...
*/sur_sc1 sur_sc2 dis_sc1 dis_sc2 ret_sc1 ret_sc2 oed_typ1 oed_typ2 oed_typ3{
...
append using "$ZEROOBS/cps199003pp.dta"
///Save file///
save "$Output/cps199003pp_filled.dta", replace
