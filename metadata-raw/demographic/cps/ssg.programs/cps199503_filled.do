...
///Open log file and use data 1995///
clear all
log using "$Programs/cpsmar_cps199503_modified.log",text replace
use "$CPSNBER/cpsmar_person_1995.dta"
...
*/a_lfsr a_untype a_ernel a_rcow workyn wtemp nwlook nwlkwk /*  
...
*/mig_st gediv mig_div perrp pemovsam pemovliv pemovsta{
...
append using "$ZEROOBS/cps199503pp.dta"
///Save file///
save "$Output/cps199503pp_filled.dta", replace
