...
clear all
log using "$Programs/cpsmar.cps199903_modified.log",text replace
use "$CPSNBER/cpsmar_person_1999.dta", replace
...
*/ a_whyabs a_payabs  priv prityp nxtres /*
...
*/ pemntvty pefntvty dephi care othstper  ihsflg   /*       
...
*/peabsrsn peio1cow prnlfsch pehruslt penatvty prcitshp pxnatvty pxmntvty pxfntvty{
 ...
 */  a_hrs1  a_uslft prityp depriv mon oth nxtres /*
...
*/ ptot_r perlis mcare mcaid champ wrk_ck penplan penincl cov_gh cov_hi /*
*/ ch_mc ch_hi axrrp axparent axage axmaritl axspouse axsex axvet /*
*/ axhga  axrace axorigin axlfsr axhrs ihsflg  /*
...
*/ ed_val csp_val alm_val fin_val oi_val ptotval pearnval pothval peinusyr

*** Fill in zero-obs file ***
append using "$ZEROOBS/cps199903pp.dta"
*** Save file ***
save "$Output/cps199903pp_filled.dta", replace
