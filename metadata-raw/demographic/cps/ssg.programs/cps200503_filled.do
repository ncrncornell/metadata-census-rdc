...
///Open log file and use data 2005///

clear all
log using "$Programs/cpsmar_cps200503_modified.log",text replace
use "$CPSNBER/cpsmar_person_2005.dta", replace
...
*/ssikidyn tranyn tranyna wicyn wicyna jryna jtyn jtyna prdtrace pehspnon prdthsp m5gsame /*
*/m5g_reg m5g_st m5g_div m5g_mtr1 m5g_mtr3 m5g_mtr4 /*
...
*/i_hrswk i_indus i_intval i_intyn i_ljcw i_lkstr i_lkweek i_losewk i_m5g1 i_m5g2 i_m5g3 /*
...
tax_inc a_vet axvet i_nxtres i_ostper i_ostyp

format a_vet %12.0g

///Append zero-obs file///
append using "$ZEROOBS/cps200503ppasec.dta"

///Save file///
save "$Output/cps200503ppasec_filled.dta", replace
log close
include config.do
exit
