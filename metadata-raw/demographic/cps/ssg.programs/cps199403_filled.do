...
///Open log file and use data 1994///
clear all
log using "$Programs/cpsmar_cps199403_modified.log",text replace
use "$CPSNBER/cpsmar_person_1994.dta"
...
*/grn_plac placdscp tc* a_werntf a_herntf htop5pct indccode h_idnum prop_tax /*
*/housret hrhtype f_mv_fs f_mv_sl pulineno
...
foreach v of var precord pppos a_parent a_exprrp a_age a_maritl a_spouse a_sex /*  
*/a_vet a_hga a_race p_stat a_reorgn a_famnum a_famtyp a_famrel a_pfrel hhdrel /* 
*/famrel hhdfmx parent age1 phf_seq pf_seq prnt_ptr  a_hrs1  a_uslft a_whyabs /* 
*/a_payabs a_wkslk  a_whenlj a_clswkr a_nlflj a_wantjb a_uslhrs a_hrlywk a_unmem /* 
*/a_uncov a_enrlw a_hscol a_ftpt a_lfsr a_untype a_wkstat a_explf a_wksch a_civlf /* 
*/a_ftlf a_mjind a_dtind a_mjocc a_dtocc a_ernel a_rcow workyn wtemp nwlook nwlkwk /*  
...
*/weind wemind migsame grin_reg grin_st mig_mtr1 mig_mtr3 mig_mtr4 migsun noemp ern_yn /*  
...
*/peabsrsn peio1cow prnlfsch peinusyr prcitshp pxnatvty pxmntvty pxfntvty pxinusyr{
...
foreach v in precord pppos a_parent a_exprrp a_age a_maritl a_spouse a_sex /*  
*/a_vet a_hga a_race p_stat a_reorgn a_famnum a_famtyp a_famrel a_pfrel hhdrel /* 
*/famrel hhdfmx parent age1 phf_seq pf_seq prnt_ptr  a_hrs1  a_uslft a_whyabs /* 
*/a_payabs a_wkslk  a_whenlj a_clswkr a_nlflj a_wantjb a_uslhrs a_hrlywk a_unmem /* 
*/a_uncov a_enrlw a_hscol a_ftpt a_lfsr a_untype a_wkstat a_explf a_wksch a_civlf /* 
...
///Save the variable labels in a local macro///
foreach v of var a_ind a_occ industry occup pehruslt penatvty pemntvty pefntvty {
 	local l`v' : variable label `v'
        if `"`l`v''"' == "" {
 		local l`v' "`v'"
  	}
...
foreach v in a_ind a_occ industry occup pehruslt penatvty pemntvty pefntvty {
	gen `v'_str= string(`v')
	recast str4 `v'_str
	format `v'_str %2s
	drop `v'
...
append using "$ZEROOBS/cps199403pp.dta"
///Save file///
save "$Output/cps199403pp_filled.dta", replace
