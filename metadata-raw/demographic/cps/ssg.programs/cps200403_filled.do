...
///Open log file and use data 2004///

clear all
log using "$Programs/cpsmar_cps200403_modified.log",text replace
use "$CPSNBER/cpsmar_person_2004.dta"

///Drop variables not contained in zero-obs dataset///
drop hrecord h_seq hhpos h_faminc h_respnm  /*
...
*/a_payabs a_pfrel  a_rcow a_sex a_spouse a_uncov a_unmem a_untype a_uslft a_uslhrs a_vet /*
*/a_wantjb a_whenlj a_whyabs a_wksch a_wkslk a_wkstat age1 axage axclswkr axenrlw axftpt /*
*/axhga axhrlywk axhrs axhscol axlfsr axmaritl axnlflj axparent axpayabs axrrp axsex /*
*/axspouse axuncov axunmem axuslhrs axvet axwhyabs caid care ch_hi ch_mc champ clwk cov_gh /*
...
*/ssikidyn tranyn tranyna wicyn wicyna jryna jtyn jtyna prdtrace pehspnon prdthsp /*
...
*/i_hrswk i_indus i_intval i_intyn i_ljcw i_lkstr i_lkweek i_losewk i_mig1 i_mig2 i_mig3 /*
*/i_mon i_noemp i_nwlkwk i_nwlook i_occup i_oedval i_oival i_ostper i_ostyp i_oth i_otyp /*
...
append using "$ZEROOBS/cps200403ppasec.dta"

///Save file///
save "$Output/cps200403ppasec_filled.dta", replace
